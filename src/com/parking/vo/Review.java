...
public class Review {
	...
	public Review(String review_c_id, int review_parking_code, int review_score, Date review_date,
			boolean review_declaration,
			String c_name) 
			{
		super();
	...
	public String toString() {
		return "Review [review_c_id=" + review_c_id + ", review_parking_code=" + review_parking_code + ", review_score="
				+ review_score + ", review_date=" + review_date + ", review_declaration=" + review_declaration
				+ ", c_name=" + 
				c_name + 
				"]";
	}
